...
### 1. Create your own copy and set up

1. Click **"Use this template"** at the top of this repo → **"Create a new repository"**.
2. Set the owner to your own account. Public or private is your choice.
3. Clone *your* new repo locally and set up:
...
When you're ready to submit, share the repo URL with us. If it's private, add GitHub user [`crodwell`](https://github.com/crodwell) as a collaborator with read access.
